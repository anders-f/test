...
const PnCheckTile$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  render() {
    return (h(Host, null, h("input", { type: "checkbox", id: this.checkboxid, checked: this.checked }), h("label", { htmlFor: this.checkboxid }, this.illustration && !this.slottedIllustration && (h("pn-illustration", { illustration: this.illustration })), h("slot", { name: "illustration" }), h("span", { class: "pn-check-tile-content" }, h("slot", null), h("svg", { class: "pn-check-tile-checkmark", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "none" }, h("polyline", { class: "checkmark-path-checked", points: "4,12 9,17 20,6", "stroke-width": "4" }))))));
  }
  get hostElement() { return this; }
  static get style() { return pnCheckTileCss; }
}, [4, "pn-check-tile", {
    "checkboxid": [1],
    "value": [8],
    "checked": [4],
...
function defineCustomElement$1() {
  ...
  const components = ["pn-check-tile", "pn-illustration"];
  components.forEach(tagName => { switch (tagName) {
    case "pn-check-tile":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PnCheckTile$1);
      }
      break;
...
const PnCheckTile = PnCheckTile$1;
const defineCustomElement = defineCustomElement$1;

export { PnCheckTile, defineCustomElement };

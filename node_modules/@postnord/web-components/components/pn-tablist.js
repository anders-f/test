...
const PnTablist$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return pnTablistCss; }
    ...
    "tabElement": [32],
    "showScrollArrows": [32],
    "scrollArrowClasses": [32]
  }, [[0, "setactivetab", "setActiveTabHandler"], [9, "resize", "handleResize"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["pn-tablist"];
  components.forEach(tagName => { switch (tagName) {
    case "pn-tablist":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PnTablist$1);
      }
      break;
  } });
}

const PnTablist = PnTablist$1;
const defineCustomElement = defineCustomElement$1;

export { PnTablist, defineCustomElement };

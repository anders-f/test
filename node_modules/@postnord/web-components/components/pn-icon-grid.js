...
import { a as allIcons, d as defineCustomElement$2 } from './pn-icon2.js';
...
const PnIconGrid$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.small = false;
  ...
  static get style() { return pnIconGridCss; }
}, [0, "pn-icon-grid", {
    "small": [4],
    "color": [1],
    "activeSymbol": [32]
...
function defineCustomElement$1() {
  ...
  const components = ["pn-icon-grid", "pn-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "pn-icon-grid":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PnIconGrid$1);
      }
      break;
    case "pn-icon":
      if (!customElements.get(tagName)) {
...
const PnIconGrid = PnIconGrid$1;
const defineCustomElement = defineCustomElement$1;

export { PnIconGrid, defineCustomElement };

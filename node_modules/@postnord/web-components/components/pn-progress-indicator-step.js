...
const PnProgressIndicatorStep$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["pn-progress-indicator-step"];
  components.forEach(tagName => { switch (tagName) {
    case "pn-progress-indicator-step":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PnProgressIndicatorStep$1);
      }
      break;
  } });
}

const PnProgressIndicatorStep = PnProgressIndicatorStep$1;
const defineCustomElement = defineCustomElement$1;

export { PnProgressIndicatorStep, defineCustomElement };

...
const PnDatePicker$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  static get style() { return pnDatePickerCss; }
    ...
    "endDate": [32],
    "open": [32],
    "activeSelectionState": [32],
    "selectionMade": [32],
    "machine": [32]
  }, [[0, "dateselection", "dateSelectionHandler"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["pn-date-picker", "pn-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "pn-date-picker":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PnDatePicker$1);
      }
      break;
    case "pn-icon":
      if (!customElements.get(tagName)) {
...
const PnDatePicker = PnDatePicker$1;
const defineCustomElement = defineCustomElement$1;

export { PnDatePicker, defineCustomElement };

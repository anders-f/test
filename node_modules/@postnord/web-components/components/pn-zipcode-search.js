...
const PnZipCodeSearch = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return pnZipcodeSearchCss; }
    ...
    "marketwebLanguage": [1, "marketweb-language"],
    "language": [32],
    "loading": [32],
    "error": [32],
    "errorMessage": [32],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "pn-zipcode-search":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PnZipCodeSearch);
      }
      break;
    case "pn-button":
      if (!customElements.get(tagName)) {
...
const PnZipcodeSearch = PnZipCodeSearch;

...
const PnSegmentedControl$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  /*---------------------------------------/SCROLL ARROW LOGIC-------------------------------------------*/
  render() {
    return (h(Host, null, h("div", { class: "pn-segmented-control" }, h("slot", null), h("div", { class: "pn-sc-bg pn-sc-active" }), h("div", { class: "pn-sc-bg pn-sc-hover" })), this.showScrollArrows && (h("div", { class: this.scrollArrowClasses() }, h("button", { class: "pn-sc-arrow-left", onClick: () => this.scroll(-120), tabindex: "-1" }, h("svg", { viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M9.414 12l7.293-7.293-1.414-1.414L6.586 12l8.707 8.707 1.414-1.414L9.414 12z" }))), h("button", { class: "pn-sc-arrow-right", onClick: () => this.scroll(120), tabindex: "-1" }, h("svg", { viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M8.707 3.293L17.414 12l-8.707 8.707-1.414-1.414L14.586 12 7.293 4.707l1.414-1.414z" })))))));
  }
  ...
  static get style() { return pnSegmentedControlCss; }
    ...
    "showLeftArrow": [32],
    "showRightArrow": [32]
  }, [[0, "change", "changeHandler"], [9, "resize", "handleResize"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["pn-segmented-control"];

...
const PnVirtualAgent$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  render() {
    if (this.status && this.show) {
      return (h("div", { class: "pn-virtual-agent" }, h("div", { id: "cention-chat-container" }), h("pn-button-container", { appearance: "secondary", style: {
          display: this.instanceActive ? 'none' : 'block',
        } }, h("button", { onClick: () => this.initVirtualAgent() }, "Chatta om ditt paket"))));
    }
  }
  static get style() { return pnVirtualAgentCss; }
}, [0, "pn-virtual-agent", {
    "parcelid": [1],
    "areaid": [2],
    "show": [4],
...
function defineCustomElement$1() {
  ...
  const components = ["pn-virtual-agent"];
  components.forEach(tagName => { switch (tagName) {
    case "pn-virtual-agent":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PnVirtualAgent$1);
      }
      break;
  } });
}

const PnVirtualAgent = PnVirtualAgent$1;
const defineCustomElement = defineCustomElement$1;

export { PnVirtualAgent, defineCustomElement };

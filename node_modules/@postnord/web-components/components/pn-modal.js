...
const PnModal$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  render() {
    return (h(Host, { "data-open": this.open }, h("div", { class: "pn-modal-backdrop", tabindex: "0" }), h("div", { class: "pn-modal" }, h("button", { class: "pn-modal-close-button", onClick: () => (this.open = false), type: "button", title: "close", "aria-label": "close" }, h("pn-icon", { symbol: "close", color: "blue700" })), h("div", { class: "pn-modal-content" }, h("slot", null)), h("slot", { name: "buttons" })), h("div", { class: "pn-modal-backdrop", tabindex: "0" })));
  }
...
function defineCustomElement$1() {
  ...
  const components = ["pn-modal", "pn-icon"];

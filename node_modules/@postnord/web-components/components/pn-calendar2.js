...
const PnCalendar = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.daychange = createEvent(this, "daychange", 7);
    this.monthchanged = createEvent(this, "monthchanged", 7);
    this.sameday = createEvent(this, "sameday", 7);
  ...
  render() {
    return (h("div", { class: "pn-calendar-wrapper" }, h("div", { class: "pn-calendar-container" }, h("div", { class: "pn-calendar-nav" }, h("div", { class: "nav-previous", onClick: this._previousMonth.bind(this) }, h("pn-icon", { symbol: "angle-small-left", color: "blue700", small: true })), h("div", { class: "pn-calendar-month", onClick: this.toggleView.bind(this) }, h("span", { class: "month-field" })), h("div", { class: "nav-next", onClick: this._nextMonth.bind(this) }, h("pn-icon", { symbol: "angle-small-right", color: "blue700", small: true }))), h("div", { class: "pn-calendar" }))));
  }
  ...
  static get style() { return pnCalendarCss; }
}, [0, "pn-calendar", {
    "language": [1],
    "min": [1],
    "max": [1],
    ...
    "disableDays": [1, "disable-days"],
    "minActiveDate": [1, "min-active-date"],
    "maxActiveDate": [1, "max-active-date"],
    "defaultDate": [1, "default-date"],
    "disableMonthsView": [4, "disable-months-view"],
    "monthView": [4, "month-view"]
  }]);
function defineCustomElement() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["pn-calendar", "pn-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "pn-calendar":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PnCalendar);
      }
      break;
    case "pn-icon":
      if (!customElements.get(tagName)) {
...
export { PnCalendar as P, defineCustomElement as d };

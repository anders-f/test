...
const Pnaccordion = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return pnAccordionCss; }
    ...
    "accordionRows": [32]
  }, [[0, "togglerow", "toggleHandler"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["pn-accordion"];
  components.forEach(tagName => { switch (tagName) {
    case "pn-accordion":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, Pnaccordion);
      }
      break;
  } });
}

const PnAccordion = Pnaccordion;
const defineCustomElement = defineCustomElement$1;

export { PnAccordion, defineCustomElement };

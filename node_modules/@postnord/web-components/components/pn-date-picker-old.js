...
import { c as createDateOrNull, d as debounce } from './helpers.js';
...
const PnDatePickerOld$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  static get style() { return pnDatePickerOldCss; }
}, [0, "pn-date-picker-old", {
    "language": [1],
    "disabled": [4],
    "emitErrors": [4, "emit-errors"],
    "label": [1],
    "min": [1],
    "max": [1],
    "invalid": [4],
    ...
    "disableInput": [4, "disable-input"],
    "startOfWeek": [2, "start-of-week"],
    "dispatchChangeOnBlur": [4, "dispatch-change-on-blur"],
    "position": [1],
    "value": [1025]
  }, [[0, "daychange", "dateChanged"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["pn-date-picker-old", "pn-calendar", "pn-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "pn-date-picker-old":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PnDatePickerOld$1);
      }
      break;
    case "pn-calendar":
      if (!customElements.get(tagName)) {
...
const PnDatePickerOld = PnDatePickerOld$1;
const defineCustomElement = defineCustomElement$1;

export { PnDatePickerOld, defineCustomElement };

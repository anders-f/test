...
const PnButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: "pn-button" }, index.h(TagName, Object.assign({ class: this.getClassNames(), "data-loading": this.loading, onClick: e => this.ripple(e, this.hostElement), "aria-label": this.ariaLabel, "aria-labelledby": this.ariaLabelledby, "data-tooltip-open": this.tooltipOpen, "aria-controls": this.ariaControls, "aria-pressed": this.ariaPressed, disabled: this.loading, form: this.form }, this.getAttributes()), index.h("div", { class: "pn-button-bg" }), index.h("div", { class: "pn-button-content" }, !this.iconOnly && index.h("slot", null), this.icon && index.h("pn-icon", { symbol: this.icon })), index.h("pn-spinner", { light: true }), this.iconOnly && (index.h("div", { class: "button-tooltip" }, index.h("slot", null))))));
  }
...
const PnSearchField = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.getClassNames() }, index.h("div", { class: "input-container" }, index.h("input", { type: "search", value: this.value, id: this.inputid, name: this.name, placeholder: this.placeholder, disabled: this.disabled, autocomplete: this.autocomplete, list: this.list, onKeyDown: e => this.emitSearch(e), onInput: e => this.setVal(e), "aria-label": this.ariaLabel }), index.h("div", { class: "button-container" }, (this.button === 'none' || this.button === 'icon-inline') && (index.h("button", { class: "search", tabindex: this.button === 'icon-inline' ? '0' : '-1', onClick: e => this.emitSearch(e), "aria-label": "search", title: "search", type: "button" }, index.h("pn-icon", { symbol: "search", color: "blue700" }))), this.button !== 'icon-inline' && (index.h("button", { class: "clear", "aria-label": "clear", title: "clear search field", tabindex: this.value && (!this.loading || this.button !== 'none') ? '0' : '-1', onClick: () => this.clearInput(), type: "button" }, index.h("pn-icon", { symbol: "close-small", color: "blue700" }))), this.button === 'none' || (this.button === 'icon-inline' && index.h("pn-spinner", null)))), this.button !== 'none' && this.button !== 'icon-inline' && (index.h("pn-button", { onClick: e => this.emitSearch(e), loading: this.loading, icon: "search", appearance: this.light ? 'light' : 'dark', "icon-only": this.button === 'icon' }, this.label))));
  }
  get hostElement() { return index.getElement(this); }
};
...
exports.pn_search_field = PnSearchField;

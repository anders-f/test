...
const PnToggleSwitch = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("input", { id: this.toggleid, name: this.name || this.toggleid, type: "checkbox", checked: this.checked, class: "pn-toggle-switch", disabled: this.disabled }), index.h("label", { htmlFor: this.toggleid, class: "pn-toggle" }, index.h("div", { class: "bg" }), index.h("div", { class: "circle" }, index.h("pn-spinner", null)))));
  }

...
const Pnselect = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.getClassNames(), tabindex: "0", "data-state": "collapsed" }, this.label && index.h("label", null, this.label), index.h("span", null, this.placeholder || ''), index.h("div", { class: "select-content", "data-select-flip": true }, index.h("div", { class: "select-bg-top", "data-select-flip": true }), index.h("div", { class: "select-bg-bottom", "data-select-flip": true }), index.h("div", { class: "select-bg" }), index.h("div", { class: "current-selection" }, this.checkbox && (index.h("pn-checkbox", { checkboxid: this.checkboxid, checked: this.checked, indeterminate: this.indeterminate })), index.h("pn-option", null, this.placeholder), index.h("svg", { class: "arrow", width: "18", height: "10", viewBox: "0 0 18 10", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M9.70711 9.70711C9.31658 10.0976 8.68342 10.0976 8.29289 9.70711L0.292892 1.70711C-0.0976315 1.31658 -0.0976315 0.683417 0.292892 0.292893C0.683418 -0.0976315 1.31658 -0.0976315 1.70711 0.292893L9 7.58579L16.2929 0.292893C16.6834 -0.0976315 17.3166 -0.0976315 17.7071 0.292893C18.0976 0.683417 18.0976 1.31658 17.7071 1.70711L9.70711 9.70711Z" }))), index.h("div", { class: "select-options", "aria-hidden": !this.open }, index.h("hr", null), this.searchable && (index.h("div", { class: "select-search", style: { '--i': '0' } }, index.h("input", { class: "select-search-input", tabindex: !this.open ? '-1' : '0', onInput: e => this.filterSearch(e), type: "text", placeholder: this.searchPlaceholder }))), index.h("slot", null))), this.error && (index.h("small", null, index.h("pn-icon", { symbol: "alert-exclamation-circle", small: true, color: "warning" }), this.error))));
  }

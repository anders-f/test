...
const PnIconGrid = class {
  constructor(hostRef) {
    ...
    this.small = false;
    this.color = colors.colors['grey-08-night'];
  ...
  render() {
    return (index.h("div", { class: "icon-grid" }, Object.keys(icons.allIcons).map((symbolName) => (index.h("div", { class: symbolName === this.activeSymbol ? 'active icon' : 'icon', onClick: () => this.copySymbolName(symbolName) }, symbolName === this.activeSymbol && index.h("span", { class: "copied" }, "Copied"), index.h("pn-icon", { symbol: symbolName, color: this.color, small: this.small }), index.h("p", { class: "symbol-name" }, symbolName), index.h("p", { class: "copy" }, "Click to copy"))))));
  }
};
PnIconGrid.style = pnIconGridCss;

exports.pn_icon_grid = PnIconGrid;

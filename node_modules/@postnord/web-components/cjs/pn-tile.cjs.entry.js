...
const Pntile = class {
  ...
  setIllustration() {
    ...
    const illustration = illustrations.allIllustrations[this.illustration];
  ...
  componentDidLoad() {
    if (this.mo)
      this.mo.disconnect();
    const mo = (this.mo = new MutationObserver(() => index.forceUpdate(this.hostElement)));
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("a", Object.assign({ class: "pn-tile-link" }, linkAttributes), this.label), index.h("div", { class: this.getClassNames() }, index.h("div", { class: "tile-circle" }), index.h("div", { class: "tile-illustration" }), !this.illustration && (index.h("div", { class: "tile-illustration-slot" }, index.h("slot", { name: "illustration" }))), index.h("div", { class: "text-cont" }, index.h("h3", null, this.label, this.target === '_blank' ? index.h("pn-icon", { symbol: "open-in-new", small: true, color: "blue700" }) : null), index.h("div", { class: "tile-slot" }, index.h("slot", null))))));
  }
  get hostElement() { return index.getElement(this); }
};
Pntile.style = pnTileCss;

exports.pn_tile = Pntile;

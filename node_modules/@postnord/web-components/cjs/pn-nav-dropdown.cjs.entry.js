...
const PnnavDropdown = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.getClassNames() }, index.h("button", { class: "pn-nav-dropdown-label", type: "button", onClick: (e) => this.ripple(e) }, this.label, this.icon ? index.h("pn-icon", { symbol: this.icon, color: "blue700" }) : null), index.h("div", { class: "nav-dropdown-content-container" }, index.h("div", { class: "nav-dropdown-content" }, index.h("slot", null)))));
  }
...
PnnavDropdown.style = pnNavDropdownCss;

exports.pn_nav_dropdown = PnnavDropdown;

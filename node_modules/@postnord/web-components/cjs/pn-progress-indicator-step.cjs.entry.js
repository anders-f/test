...
const PnProgressIndicatorStep = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.getClassNames(), onClick: () => this.setActiveStepHandler() }, index.h("div", { class: "progress-line" }), index.h("div", { class: "info-container" }, index.h("slot", null), this.name), index.h("div", { class: "circle" }, this.done || this.checked ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", "enable-background": "new 0 0 24 24", id: "checkmark", version: "1.0", viewBox: "0 0 24 24" }, index.h("polyline", { class: "checkmark-path", fill: "none", points: "20,6 9,17 4,12", stroke: "#FFF", "stroke-miterlimit": "10", "stroke-width": "3" }))) : (''))));
  }
};

...
const PnPageNav = class {
  constructor(hostRef) {
    ...
    this.navchange = index.createEvent(this, "navchange", 7);
  ...
  /* ---------------------------------------/DROPDOWN LOGIC--------------------------------------- */
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "pn-page-nav-wrapper" }, index.h("nav", { class: "pn-page-nav" }, this.dropdownActive && (index.h("button", { type: "button", class: this.dropdownButtonClasses(), onClick: () => this.toggleDropdown(), "aria-controls": "page-nav-dropdown", "aria-expanded": `${this.dropdownOpen}` }, this.dropdown, index.h("pn-icon", { symbol: "angle-down", color: "white", small: true }), index.h("div", { class: "pn-page-nav-divider" }))), index.h("ul", { class: "pn-page-nav-items" }, index.h("slot", null), index.h("div", { class: "pn-pn-bg pn-pn-active" }), index.h("div", { class: "pn-pn-bg pn-pn-hover" }))), this.showScrollArrows && (index.h("div", { class: this.scrollArrowClasses() }, index.h("button", { class: "pn-pn-arrow-left", onClick: () => this.scroll(-120), tabindex: "-1" }, index.h("pn-icon", { symbol: "arrow-left", color: "white" })), index.h("button", { class: "pn-pn-arrow-right", onClick: () => this.scroll(120), tabindex: "-1" }, index.h("pn-icon", { symbol: "arrow-right", color: "blue700" }))))), this.dropdownActive && (index.h("ul", { class: this.dropdownClasses(), id: "page-nav-dropdown", "aria-hidden": `${!this.dropdownOpen}` }, index.h("slot", { name: "dropdown-item" })))));
  }

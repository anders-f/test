...
const Pntoast = class {
  ...
  render() {
    return (index.h(index.Host, { "data-hidden": this.hidden, class: this.getClassNames() }, this.icon && index.h("pn-icon", { symbol: this.icon }), index.h("div", { class: "content" }, index.h("slot", null)), this.closable && (index.h("button", { onClick: () => this.closeToast(), type: "button", title: "close", "aria-label": "close" }, index.h("pn-icon", { symbol: "close", small: true })))));
  }

...
const helpers = require('./helpers-f38ea13c.js');
...
const PnFileUpload = class {
  constructor(hostRef) {
    ...
    this.filesAdded = index.createEvent(this, "filesAdded", 7);
    this.update = index.createEvent(this, "update", 7);
    this.fileuploaderror = index.createEvent(this, "fileuploaderror", 7);
    this.valid = index.createEvent(this, "valid", 7);
    this.uploadFile = index.createEvent(this, "uploadFile", 7);
    this.uploadCancelled = index.createEvent(this, "uploadCancelled", 7);
    this.uploadCompleted = index.createEvent(this, "uploadCompleted", 7);
  ...
  initMaxBytes() {
    this.maxSizeInBytes = helpers.getBytesFromHumanReadableFileSize(this.maxSize);
  }
  componentDidLoad() {
  ...
  render() {
    return (index.h("div", { class: "pn-file-upload-container" }, index.h("div", { class: "pn-dropzone-container" }, index.h("div", { class: "pn-dropzone-inner" }, index.h("div", { class: "pn-file-upload-dropzone", onDragOver: this._onDragOverFile.bind(this), onDragLeave: this._onDragLeaveFile.bind(this), onDrop: this._onDropFile.bind(this) }, index.h("div", { class: "default-message-container" }, this.disabled || this.invalid ? (index.h("pn-icon", { class: "pn-file-upload-dropzone-icon", symbol: "disabled", color: "grey-06-rock" })) : (index.h("pn-icon", { class: "pn-file-upload-dropzone-icon", symbol: "upload", color: "grey-06-rock" })), index.h("slot", null))))), index.h("section", { class: "files-list" }, this.files.map((file) => (index.h("div", { class: "files-list-item-container" }, index.h("div", { class: "files-list-item" }, index.h("pn-progress-bar", { label: file.filename, "show-spinner": this.showSpinner && file.progress < 100 && file.status === 'start', progress: file.progress, color: file.status === 'error' ? 'error' : 'default', size: "small", width: "100%" }), index.h("div", { class: "icon-button" }), index.h("pn-icon", { symbol: "minus-circle", color: "grey-05-battleship", onClick: this._removeFile(file, this) })), file.error ? index.h("div", { class: "files-list-item-error" }, file.errorMessage || file.error.message) : null)))), index.h("input", { type: "file", name: "pnFileUpload[]", class: "pn-file-upload-input", multiple: this.multiple, accept: this.accept })));
  }
...
PnFileUpload.style = pnFileUploadCss;

exports.pn_file_upload = PnFileUpload;

...
const PnTablist = class {
  ...
  render() {
    return (index.h(index.Host, { role: "tablist", "aria-label": "tablist", class: this.getClassNames() }, index.h("div", { class: "tablist" }, index.h("slot", null), index.h("div", { class: "line" }, index.h("div", { class: "active-line" }), index.h("div", { class: "hovered-line" }))), this.showScrollArrows && (index.h("div", { class: this.scrollArrowClasses }, index.h("button", { class: "arrow-left", onClick: () => this.scroll(-120), tabindex: "-1" }, index.h("svg", { viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M9.414 12l7.293-7.293-1.414-1.414L6.586 12l8.707 8.707 1.414-1.414L9.414 12z" }))), index.h("button", { class: "arrow-right", onClick: () => this.scroll(120), tabindex: "-1" }, index.h("svg", { viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M8.707 3.293L17.414 12l-8.707 8.707-1.414-1.414L14.586 12 7.293 4.707l1.414-1.414z" })))))));
  }

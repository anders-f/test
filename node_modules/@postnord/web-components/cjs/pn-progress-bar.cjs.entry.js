...
const PnSpinner = class {
  ...
  render() {
    ...
    return (index.h("div", { class: "pn-progress-container", style: styles }, this._hasLabel() ? (index.h("div", { class: "pn-progress-label" }, this.label, this.showSpinner ? index.h("pn-spinner", null) : null)) : null, index.h("div", { class: "pn-progress-bar" }, index.h("div", { class: "pn-progress-bar-line", style: progressStyles }, index.h("div", { class: "pn-progress-bar-line1" }), index.h("div", { class: "pn-progress-bar-line2" })), index.h("div", { class: "pn-progress-bar-bg" })), this.showPercentage ? (index.h("div", { class: "pn-progress-percentage", style: progressStyles }, progress, "%")) : null));
  }
  _hasLabel() {
...
exports.pn_progress_bar = PnSpinner;

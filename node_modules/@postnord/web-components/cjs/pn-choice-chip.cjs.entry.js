...
const Pnchoicechip = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("input", { type: "checkbox", id: this.choiceid, value: this.value, name: this.name || this.choiceid, disabled: this.disabled, checked: this.checked }), index.h("label", { htmlFor: this.choiceid, class: "pn-choice-chip" }, index.h("slot", null))));
  }

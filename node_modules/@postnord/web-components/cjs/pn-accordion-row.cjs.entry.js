...
const PnaccordionItem = class {
  constructor(hostRef) {
    ...
    this.togglerow = index.createEvent(this, "togglerow", 7);
  ...
  /*---------------------------------------/UTILS-------------------------------------------*/
  render() {
    return (index.h(index.Host, { "data-state": "collapsed" }, index.h("div", { class: "accordion-content" }, index.h("button", { type: "button", class: "accordion-title", onClick: (e) => this.clickHandler(e) }, this.label ? this.label : '', index.h("slot", { name: "label" }), index.h("svg", { width: "18", height: "10", viewBox: "0 0 18 10", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M9.70711 9.70711C9.31658 10.0976 8.68342 10.0976 8.29289 9.70711L0.292892 1.70711C-0.0976315 1.31658 -0.0976315 0.683417 0.292892 0.292893C0.683418 -0.0976315 1.31658 -0.0976315 1.70711 0.292893L9 7.58579L16.2929 0.292893C16.6834 -0.0976315 17.3166 -0.0976315 17.7071 0.292893C18.0976 0.683417 18.0976 1.31658 17.7071 1.70711L9.70711 9.70711Z", fill: "#232228" }))), index.h("div", { class: "content" }, index.h("slot", null)))));
  }
  get hostElement() { return index.getElement(this); }
};
PnaccordionItem.style = pnAccordionRowCss;

exports.pn_accordion_row = PnaccordionItem;

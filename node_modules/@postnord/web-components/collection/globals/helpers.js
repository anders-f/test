...
export const getBytesFromHumanReadableFileSize = function (sizeString) {
...
export const createDateOrNull = function (dateStr) {
...
export const getMonthNamesByLanguage = function (language = "en") {
...
export const getDayNamesByLanguage = function (language = "en") {
  if (allowedLanguages.indexOf(language) === -1)
    language = "en";
  const daysLanguages = {
...
export const computeMonths = function (date) {

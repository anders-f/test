...
export class PnVirtualAgent {
  ...
  render() {
    if (this.status && this.show) {
      return (h("div", { class: "pn-virtual-agent" },
        h("div", { id: "cention-chat-container" }),
        h("pn-button-container", { appearance: "secondary", style: {
            display: this.instanceActive ? 'none' : 'block',
          } },
          h("button", { onClick: () => this.initVirtualAgent() }, "Chatta om ditt paket"))));
    }
  }
  static get is() { return "pn-virtual-agent"; }
  static get originalStyleUrls() { return {
    "$": ["pn-virtual-agent.scss"]
  }; }
  static get styleUrls() { return {
    "$": ["pn-virtual-agent.css"]
  }; }
  static get properties() { return {
    "parcelid": {
      ...
      "docs": {
        "tags": [],
        "text": "The ID of the pracel you want to pass to the agent"
      },
      "attribute": "parcelid",
      "reflect": false,
      "defaultValue": "''"

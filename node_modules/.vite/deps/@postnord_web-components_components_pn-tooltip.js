...
var PnTooltip$1 = proxyCustomElement(class extends H {
  ...
  render() {
    return h("button", { class: this.getClassNames(), "data-open": this.open }, h("pn-icon", { symbol: this.getSymbol(), color: this.color }), h("div", { class: "pn-tooltip-content" }, h("slot", null)));
  }
  get hostElement() {
    return this;
  }
...
function defineCustomElement$1() {
  ...
  const components = ["pn-tooltip", "pn-icon"];
  components.forEach((tagName) => {
    switch (tagName) {
      case "pn-tooltip":
        if (!customElements.get(tagName)) {
          customElements.define(tagName, PnTooltip$1);
        }
        break;
      case "pn-icon":
        if (!customElements.get(tagName)) {
...
var PnTooltip = PnTooltip$1;
var defineCustomElement2 = defineCustomElement$1;
export {
  PnTooltip,
  defineCustomElement2 as defineCustomElement
};
//# sourceMappingURL=@postnord_web-components_components_pn-tooltip.js.map
